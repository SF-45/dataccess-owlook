...
public class TableDataFilterController extends FXMLController {
  ...
  public TableDataFilterController(Owl<TableDataFilter> filterOwl, Owl<TableData> tebleDataOwl)
  ...
  public TableDataFilterController(Owl<TableDataFilter> filterOwl) throws ControllerException {
    super(ResourceTarget.class.getResource("fxml/edit-filter.fxml"));
    this.filterOwl = filterOwl;
